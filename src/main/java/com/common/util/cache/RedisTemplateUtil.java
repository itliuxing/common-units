...
public class RedisTemplateUtil {
     ...
     * @param time
     */
    public void setObjectForTimeMIN(String key,Object obj,long time){
     ...
     * @return 删除成功的 数量
     */
    public void deleteTop(String key){
     ...
     * @param value
     */
    public void putObj(String key, String hashKey, Object value){
        redisTemplate.opsForHash().put(key, hashKey, value);
    }
